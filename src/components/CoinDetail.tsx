    ...
    <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center mb-8">
        ...
        <div className="ml-4">
          ...
          <div className="flex items-center">
            ...
            <span className="ml-2 px-2 py-0.5 bg-purple-500/20 rounded-full text-purple-300 text-sm">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/4 space-y-6">
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-sm rounded-lg hover:opacity-90 transition-opacity"
              >
                Add to Portfolio
              </button>
            </div>
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="p-4 rounded-xl border border-white/10 bg-white/5">
                ...
                <p className="text-white font-medium">${formatPrice(coin.market_cap)}</p>
              </div>

              <div className="p-4 rounded-xl border border-white/10 bg-white/5">
                <h3 className="text-gray-400 text-sm mb-1">24h Trading Volume</h3>
                <p className="text-white font-medium">${formatPrice(coin.total_volume)}</p>
              </div>

              <div className="p-4 rounded-xl border border-white/10 bg-white/5">
                <h3 className="text-gray-400 text-sm mb-1">24h High</h3>
                <p className="text-white font-medium">${formatPrice(coin.high_24h)}</p>
              </div>

              <div className="p-4 rounded-xl border border-white/10 bg-white/5">
                <h3 className="text-gray-400 text-sm mb-1">24h Low</h3>
                <p className="text-white font-medium">${formatPrice(coin.low_24h)}</p>
              </div>

              <div className="p-4 rounded-xl border border-white/10 bg-white/5">
                <h3 className="text-gray-400 text-sm mb-1">Circulating Supply</h3>
            ...
            <div className="space-y-4">
              ...
              {coin.links.homepage[0] && (
                <a
                  ...
                  className="flex items-center p-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors"
                >
                  <svg className="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                  </svg>
                  <span className="ml-3 text-white">Website</span>
                </a>
              )}
              ...
              {coin.links.blockchain_site[0] && (
                ...
                >
                  ...
                  <span className="ml-3 text-white">Explorer</span>
                </a>
              )}
              ...
              {coin.links.twitter_screen_name && (
                ...
                >
                  ...
                  <span className="ml-3 text-white">Twitter</span>
                </a>
              )}
              ...
              {coin.links.subreddit_url && (
                ...
                >
                  ...
                  <span className="ml-3 text-white">Reddit</span>
                </a>
              )}
              ...
              {coin.links.telegram_channel_identifier && (
                ...
                >
                  ...
                  <span className="ml-3 text-white">Telegram</span>
                </a>
              )}
            </div>
          </div>
          ...
          {/* Technical Analysis */}
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 h-[450px] overflow-hidden">
            <div className="p-6 pb-2">
              <h2 className="text-xl font-bold text-white mb-2">Technical Analysis</h2>
            </div>
